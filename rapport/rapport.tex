...
% Arbetet ska effektiviseras genom att ha kontinuerliga utvärderingar av arbetsprocessen. Vidare ska gruppen se till att alla bidrar maximalt till projektet.
...
\subfigure{\includegraphics[width=0.5\textwidth]{bilder/bilddata2.png} }}
...
\includepdf[pages=-]{anvandartest.pdf}
\end{document}
