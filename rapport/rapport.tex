...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{bilder/granssnitt.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{bilder/save_doover.jpg}
  \caption{Gränssnittet när modellen presenteras för användaren}
  \label{fig:gui2}
\end{figure}
...
\caption[Bilder från ytrekonstruktion]{(A) Bild på rå punktdata. (B) Reducering av punktdata. (C) Reducering av brus. (D) Yta med Poissons metod för ytrekonstruktion}
\label{fig:scans}
\end{figure}
