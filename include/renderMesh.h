...
class renderMesh
{
	public:
		...
		static void runPoisson(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud2, pcl::PolygonMesh &mesh);
		...
		static  pcl::PolygonMesh runGreedyProjectionTriangulation(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud,pcl::PointCloud<pcl::PointXYZ>::Ptr cloud2);
